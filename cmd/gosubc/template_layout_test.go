...
func TestTemplateLayout_Execute(t *testing.T) {
	...
	cmd := parent.NewTemplateLayout()

	called := false
	cmd.CommandAction = func(c *TemplateLayout) error {
		called = true
		return nil
	}
...
func TestTemplateLayout_ExecuteHelpAndUnknownFlags(t *testing.T) {
