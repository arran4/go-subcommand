...
func (c *RootCmd) NewGenerate() *Generate {
	...
	set.BoolVar(&v.force, "force", false, "Overwrite existing files not generated by gosubc")
	set.BoolVar(&v.force, "f", false, "Overwrite existing files not generated by gosubc")
	set.Usage = v.Usage

	v.CommandAction = func(c *Generate) error {

		err := go_subcommand.Generate(c.dir, c.manDir, c.parserName, c.force)
		if err != nil {
