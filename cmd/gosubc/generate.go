...
func (c *RootCmd) NewGenerate() *Generate {
	...
	set.BoolVar(&v.force, "force", false, "Overwrite files not generated by gosubc and ignore extraneous files")
	set.Usage = v.Usage

	v.CommandAction = func(c *Generate) error {

		err := go_subcommand.Generate(c.dir, c.manDir, c.parserName, c.paths, c.recursive, c.force)
		if err != nil {
