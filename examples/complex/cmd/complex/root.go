...
func NewRoot(name, version, commit, date string) (*RootCmd, error) {
	...
	{
		subCmd := NewLazyCommand(func() Cmd { return c.NewAnother() })
		c.Commands["another"] = subCmd

	}

	{
		subCmd := NewLazyCommand(func() Cmd { return c.NewToplevel() })
		c.Commands["toplevel"] = subCmd
