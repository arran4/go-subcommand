...
import (
	...
	"github.com/arran4/go-subcommand/examples/defaultexpr/cmd/app/templates"
)
...
func NewRoot(name, version, commit, date string) (*RootCmd, error) {
	...
	c.IntVar(&c.cores, "cores", runtime.NumCPU(), "Number of cores")

	c.IntVar(&c.limit, "limit", math.MaxInt32, "Max limit")
